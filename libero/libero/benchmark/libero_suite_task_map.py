libero_task_map = {
    ...
    "libero_stove": [
        "KITCHEN_SCENE_heat_the_tomato_sauce_on_the_stove_for_1.4_second_and_then_heat_the_alphabet_soup",
        "KITCHEN_SCENE_heat_the_alphabet_soup_on_the_stove_for_1.4_second_and_then_heat_the_tomato_sauce"
    ],
    "libero_spatial": [
